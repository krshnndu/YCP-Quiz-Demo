        ...
        if( is_array( $answered_keywords ) && !empty( $answered_keywords ) ){
            foreach ($answered_keywords as $key => $answered_keyword) {
                ...
                if( $apply_points_to_keywords ){
                    if( array_key_exists( $answered_keyword_cat_id, $question_cat_results ) ){
                        if( !array_key_exists( $answered_keyword_keyword, $question_cat_results[$answered_keyword_cat_id]['keywords'] ) ){
                    ...
                    if( isset( $question_cat_results ) && !empty($question_cat_results) ){
                        if( array_key_exists( $answered_keyword_cat_id, $question_cat_results ) ){
                            if( isset( $question_cat_results[$answered_keyword_cat_id]['keywords'] ) && !array_key_exists( $answered_keyword_keyword, $question_cat_results[$answered_keyword_cat_id]['keywords'] ) ){
